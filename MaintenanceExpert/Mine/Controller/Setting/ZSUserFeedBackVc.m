...
@interface ZSUserFeedBackVc ()<UITextViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@implementation ZSUserFeedBackVc
...
- (void)viewDidLoad {
    ...
    _aView.backgroundColor = UIView_BackView_color;
    _aView.frame = CGRectMake(10, 20, self.view.frame.size.width - 20, 180);
    [self.view addSubview:_aView];
    self.navigationItem.title = @"意见反馈";
    
    
    self.wordCountLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.textView.frame.origin.x + 10,  self.textView.frame.size.height + 20, [UIScreen mainScreen].bounds.size.width - 20, 20)];
    _wordCountLabel.font = [UIFont systemFontOfSize:14.f];
    _wordCountLabel.textColor = Label_Color;
    self.wordCountLabel.text = @"0/300";
    self.wordCountLabel.backgroundColor = [UIColor clearColor];
    self.wordCountLabel.textAlignment = NSTextAlignmentRight;
    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(self.textView.frame.origin.x + 10,  self.textView.frame.size.height + 20 - 1 + 23, [UIScreen mainScreen].bounds.size.width - 20, 1)];
    ...
    [_photoBtn setImage:[UIImage imageNamed:@"UserFeed_addPhoto"] forState:UIControlStateNormal];
...
-(void)addLabelText{
    ...
    labelText.textColor = Placeholder_Color;
...
-(void)addCollectionViewPicture{
    ...
    _collectionV.backgroundColor = UIView_BackView_color;
...
-(void)addContactInformation{
    _textField = [[UITextField alloc]initWithFrame:CGRectMake(10, 250, [UIScreen mainScreen].bounds.size.width - 20, 40)];
    _textField.textColor = TextField_Text_Color;
    _textField.backgroundColor = UIView_BackView_color;
    _textField.font = [UIFont systemFontOfSize:14.f];
    NSString *textFieldStr = @" 你的联系方式(手机号，QQ号或电子邮箱)";
    NSMutableAttributedString *textFieldPlace = [[NSMutableAttributedString alloc]initWithString:textFieldStr];
    [textFieldPlace addAttribute:NSForegroundColorAttributeName
                         value:Placeholder_Color
                         range:NSMakeRange(0, textFieldStr.length)];
    _textField.attributedPlaceholder = textFieldPlace;
...
-(PlaceholderTextView *)textView{
    ...
    if (!_textView) {
        ...
        _textView.backgroundColor = UIView_BackView_color;
        ...
        _textView.layer.borderColor = Label_Color.CGColor;
        _textView.layer.borderWidth = 0.5;
        _textView.placeholderColor = Placeholder_Color;
...
- (UIButton *)sendButton{
    ...
    if (!_sendButton) {
        ...
        _sendButton.frame = CGRectMake(10, 320, self.view.frame.size.width - 20, 40);
        [_sendButton setBackgroundImage:[UIImage imageNamed:@"wancheng"] forState:UIControlStateNormal];
