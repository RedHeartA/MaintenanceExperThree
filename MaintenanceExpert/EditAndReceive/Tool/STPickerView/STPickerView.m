...
- (void)setupDefault
{
    ...
    self.contentView.backgroundColor = ColorWithRGBA(17, 88, 161, 1);
    [self.contentView addSubview:self.lineView];
    self.lineView.backgroundColor = Line_Color;
    [self.contentView addSubview:self.pickerView];
    self.pickerView.backgroundColor = ColorWithRGBA(17, 88, 161, 1);
    [self.contentView addSubview:self.buttonLeft];
    [self.contentView addSubview:self.buttonRight];
    [self.contentView addSubview:self.labelTitle];
    self.labelTitle.textColor = TextField_Text_Color;
...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        [_buttonLeft setTitleColor:TextField_Text_Color forState:UIControlStateNormal];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:TextField_Text_Color forState:UIControlStateNormal];
